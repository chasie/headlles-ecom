...
class ProductTest extends TestCase
{
    ...
    public function can_make_a_product()
    {
        $attribute_data = collect([
            'meta_title' => new \HeadlessEcom\FieldTypes\Text('I like cake'),
            'pack_qty' => new \HeadlessEcom\FieldTypes\Number(12345),
            'description' => new \HeadlessEcom\FieldTypes\TranslatedText(collect([
                'en' => new \HeadlessEcom\FieldTypes\Text('Blue'),
                'fr' => new \HeadlessEcom\FieldTypes\Text('Bleu'),
            ])),
        ]);
