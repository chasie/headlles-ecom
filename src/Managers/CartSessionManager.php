...
class CartSessionManager implements CartSessionInterface
{
    ...
    public function current($estimateShipping = false)
    {
        return $this->fetchOrCreate(
            config('headless-ecom.cart.auto_create', false),
     ...
     *
     * @return \HeadlessEcom\Models\Cart
     */
     ...
     *
     * @param  bool  $create
     * @return \HeadlessEcom\Models\Cart|null
     */
    private function fetchOrCreate($create = false, bool $estimateShipping = false)
    {
        ...
        $this->cart = Cart::with(
            config('headless-ecom.cart.eager_load', [])
        )->find($cartId);
    ...
    {
        return config('headless-ecom.cart.session_key');
    }
     ...
     *
     * @param  bool  $forget
     * @return \HeadlessEcom\Models\Order
     */
