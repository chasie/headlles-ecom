...
use HeadlessEcom\Exceptions\CustomerNotBelongsToUserException;
...
class StorefrontSessionManager implements StorefrontSessionInterface
{
    ...
    public function initCustomer(): ?Customer
    {
        ...
        if (! $customer_id) {
            if ($this->authManager->check() && is_HeadlessEcom_user($this->authManager->user())) {
    ...
    {
        return 'headless-ecom_storefront';
    }
    ...
    public function setCustomer(Customer $customer): self
    {
        ...
        if (
            ...
            && is_HeadlessEcom_user($this->authManager->user())
