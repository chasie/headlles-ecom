...
namespace HeadlessEcom\DataTypes;

use HeadlessEcom\Exceptions\InvalidDataTypeValueException;
use HeadlessEcom\Models\Currency;
use HeadlessEcom\Pricing\DefaultPriceFormatter;
...
class Price
{
    ...
    {
        return app(
            config('headless-ecom.pricing.formatter', DefaultPriceFormatter::class),
            [
                'value' => $this->value,
