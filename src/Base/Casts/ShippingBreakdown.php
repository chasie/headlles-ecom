...
class ShippingBreakdown implements CastsAttributes, SerializesCastableAttributes
{
     ...
     * @return \HeadlessEcom\Base\ValueObjects\Cart\ShippingBreakdown
     */
    public function get($model, $key, $value, $attributes)
    {
        $breakdown = new \HeadlessEcom\Base\ValueObjects\Cart\ShippingBreakdown();
     ...
     * @param  \Illuminate\Database\Eloquent\Model  $model
     * @param  string  $key
     * @param  \HeadlessEcom\Base\ValueObjects\Cart\ShippingBreakdown  $value
     * @param  array  $attributes
     * @return array
     */
    public function set($model, $key, $value, $attributes)
    {
        if ($value && ! is_a($value, \HeadlessEcom\Base\ValueObjects\Cart\ShippingBreakdown::class)) {
            throw new \Exception('Shipping breakdown must be instance of HeadlessEcom\Base\ValueObjects\Cart\ShippingBreakdown');
        }
